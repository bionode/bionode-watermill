...
const { 
  setWorfklowStatusPermanentFailure,
  setWorkflowStatusTemporaryFailure,
  setWorkflowStatusSuccess
 } = require('../reducers/workflowState.js')
...
function* lifecycle (action) {
  ...
  function* operationSaga (operationCreator) {
    ...
    try {
      ...
      yield* fail(uid)
      yield put(setWorkfowStatusPermanentFailure())
      yield put(setWorkflowStatusTemporaryFailure())
      yield put(setWorkflowStatusSuccess())
      return false
    }
  }
